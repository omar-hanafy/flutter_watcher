...
extension ListWatcherExtension<E> on Watcher<List<E>> {
  ...
  /// ```
  void add(E value, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// ```
  void addAll(Iterable<E> iterable, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// ```
  void sort([int Function(E a, E b)? compare, bool forceRefresh = false]) {
    updateOnAction(
      () => value.sort(compare),
      forceRefresh: forceRefresh,
    );
  ...
  /// ```
  void shuffle([Random? random, bool forceRefresh = false]) {
    updateOnAction(
  ...
  /// print(numbers); // []
  /// ```
  void clear({bool forceRefresh = false}) {
    updateOnAction(
      () => value.clear(),
      forceRefresh: forceRefresh,
    );
  ...
  /// ```
  void insert(int index, E element, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// ```
  void insertAll(int index, Iterable<E> iterable, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// ```
  void setAll(int index, Iterable<E> iterable, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// print(parts); // [shoulders, knees, toes]
  /// ```
  bool remove(Object? value, {bool forceRefresh = false}) {
    return updateOnAction(
  ...
  /// ```
  E removeLast({bool forceRefresh = false}) => updateOnAction(
        () => value.removeLast(),
        forceRefresh: forceRefresh,
      );
  ...
  /// ```
  E removeAt(int index, {bool forceRefresh = false}) => updateOnAction(
  ...
  /// ```
  /// The list must be growable.
  void removeWhere(bool Function(E element) test, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  /// ```
  /// The list must be growable.
  void retainWhere(bool Function(E element) test, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  void setRange(int start, int end, Iterable<E> iterable,
      [int skipCount = 0, bool forceRefresh = false]) {
    updateOnAction(
  ...
  /// print(numbers); // [1, 5]
  /// ```
  void removeRange(int start, int end, {bool forceRefresh = false}) {
    updateOnAction(
  ...
  void fillRange(int start, int end,
      [E? fillValue, bool forceRefresh = false]) {
    updateOnAction(
