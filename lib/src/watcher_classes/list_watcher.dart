...
class ListWatcher<E> extends Watcher<List<E>> implements List<E> {
  ...
  /// Generates a WatcherList with values.
  factory ListWatcher.generate(int length, E Function(int index) generator,
          {bool growable = true}) =>
      ListWatcher(List.generate(length, generator, growable: growable));
